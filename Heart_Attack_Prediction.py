#Heart Attack Prediction Prediction using Python Machine Learning and mysql
...
def analysis():
    ...
    A=today.year-DOB.get()  # Check this line
    ...
    if (prediction[0]==0):
        ...
        report.config(text=f"Report:{1}",fg="#ed3c24")
        report1.config(text=f"{name},you do not have a heart disease")
...
def Info():
    ...
    #icon_image
    icon_image=PhotoImage(file="Heart_Attack_Prediction-using-Machine-Learning/Images/info.png")
...
#ICON 1
image_icon=PhotoImage(file="Heart_Attack_Prediction-using-Machine-Learning/Images/icon.png")
root.iconphoto(False,image_icon)

#Header Section 2
logo=PhotoImage(file="Heart_Attack_Prediction-using-Machine-Learning/Images/header.png")
...
Entry_image=PhotoImage(file="Heart_Attack_Prediction-using-Machine-Learning/Images/Rounded Rectangle 1.png")
Entry_image2=PhotoImage(file="Heart_Attack_Prediction-using-Machine-Learning/Images/Rounded Rectangle 2.png")
...
####################################### <Report> ###########################################################
square_report_image=PhotoImage(file="Heart_Attack_Prediction-using-Machine-Learning/Images/Report.png")
...
################################################ Graph ##############################################################
graph_image=PhotoImage(file="Heart_Attack_Prediction-using-Machine-Learning/Images/graph.png")
...
################################################ Button ##############################################################
analysis_button=PhotoImage(file="Heart_Attack_Prediction-using-Machine-Learning/Images/Analysis.png")
Button(root,image=analysis_button,bd=0,bg=background,cursor='hand2',command=analysis).place(x=1130,y=240)

################################################## Info button ########################################################
info_button=PhotoImage(file="Heart_Attack_Prediction-using-Machine-Learning/Images/info.png")
Button(root,image=info_button,bd=0,bg=background,cursor='hand2',command=Info).place(x=10,y=240)


################################################## Save button ########################################################
save_button=PhotoImage(file="Heart_Attack_Prediction-using-Machine-Learning/Images/save.png")
...
smoking_icon=PhotoImage(file="Heart_Attack_Prediction-using-Machine-Learning/Images/smoker.png")
non_smoking_icon=PhotoImage(file="Heart_Attack_Prediction-using-Machine-Learning/Images/non-smoker.png")
...
logout_icon=PhotoImage(file="Heart_Attack_Prediction-using-Machine-Learning/Images/logout.png")
